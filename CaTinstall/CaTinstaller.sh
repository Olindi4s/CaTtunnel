...
then
	...
	xterm -title "Arduino Downloader" -bg "#000000" -fg "#1ec503" -geometry 159x70-0-0 -e sudo wget https://download1483.mediafire.com/p8x6w3i1ogmg/j0778p1prfgvb2n/Arduino.zip &
	wait
