...
then
	...
	cd /usr/local/bin
	xterm -title "Ngrok Install" -bg "#000000" -fg "#1ec503" -geometry 159x70-0-0 -e sudo wget https://download2281.mediafire.com/dehii4ue5ipg/v41hju0imkx55ps/ngrok &
	wait 
...
then
	...
	xterm -title "Arduino Downloader" -bg "#000000" -fg "#1ec503" -geometry 159x70-0-0 -e sudo wget https://download1483.mediafire.com/pnye3k7cy8pg/0qmrcizp25oytvq/Arduino.zip &
	wait
